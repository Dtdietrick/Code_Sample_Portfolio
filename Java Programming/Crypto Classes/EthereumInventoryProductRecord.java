 ...
 *               contains relevant code for creating ethereum record 
 ...
 * 
 */
public class EthereumInventoryProductRecord extends InventoryProduct{
    
    public static final int ETHEREUM_INVENTORY_PRODUCT_RECORD_SIZE = 
            (Integer.BYTES * 5)
    ...
    {
        this(1,2,"Ethereum",200.00,50,6,3);
    }
