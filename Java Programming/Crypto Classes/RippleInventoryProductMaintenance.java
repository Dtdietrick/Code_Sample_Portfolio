 ...
 *            the Ripple Inventory Product file and handle exceptions
 ...
 *
 */
public class RippleInventoryProductMaintenance extends 
        RippleInventoryProductRecord
{
    ...
    public void closeInventoryFile() throws IOException
    {
     ...
     public void insertInventoryRecord
                    (RippleInventoryProductRecord inventoryProductRecord)
            ...
            throws IllegalArgumentException, IOException
    {
        ...
        else
        {
            ...
            (inventoryProductRecord.getInventoryRecordNumber() - 1 )
                * RippleInventoryProductRecord.
                RIPPLE_INVENTORY_PRODUCT_RECORD_SIZE);
    ...
    public RippleInventoryProductRecord 
           ...
           throws IOException
    {
        RippleInventoryProductRecord inventoryProductRecord = new
        RippleInventoryProductRecord();
